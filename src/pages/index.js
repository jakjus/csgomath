								...
								<div class="row">
									...
									<div class="col-8">
										<div class="card-body d-flex flex-column align-items-start">
											...
											<h4 class="mb-0">
												<Link to={r.case.name} style={{fontFamily: "DM Serif Display"}} class="text-dark" href="#">
													{r.case.name}
												</Link>
											</h4>
								...
								<div class="row">
									...
									<div class="col-8">
										<div class="card-body d-flex flex-column align-items-start">
											...
											<h4 class="mb-0">
												<Link to={r.key.name} style={{fontFamily: "DM Serif Display"}} class="text-dark" href="#">
													{r.key.name}
												</Link>
											</h4>
											<div class="mb-1 text-muted">{r.datetime}</div>
						...
						<div class="row no-gutters mt-2">
							<ul class="list-group col">
								...
								<li class="list-group-item d-flex justify-content-between lh-condensed">
									...
									>
										{Math.round((r.value - (r.key.sale_price + r.case.sale_price)) /
											(r.key.sale_price + r.case.sale_price)*100)+'%'}
									</strong>
								</li>
							</ul>
						</div>
